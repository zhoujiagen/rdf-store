...
public class TestMySqlParser {
  ...
  public static String TEST_QUERY_DIR = "src/test/resources/sql";
  public static String alert_table_path = TEST_QUERY_DIR + "/alert_table.sql";
  public static String create_table_path = TEST_QUERY_DIR + "/create_table.sql";
  public static String data_path = TEST_QUERY_DIR + "/data.sql";
  public static String all_path = TEST_QUERY_DIR + "/all.sql";
